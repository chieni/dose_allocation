...
def select_final_dose(num_subgroups, num_doses, dose_labels, x_test, max_doses,
    ...
    # Unconstrainted version - but utility should help with taking toxicity into account
    ...
    for subgroup_idx in range(num_subgroups):
        ...
        eff_mean[~available_doses_mask] = -np.inf
        thall_utilities[~available_doses_mask] = -np.inf
